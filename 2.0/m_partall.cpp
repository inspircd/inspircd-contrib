...
/* $ModDesc: Implement JOIN 0 (joining 0 makes a user part all channels) as PARTALL. */
/* $ModDepends: core 2.0 */
...
class ModuleJoinZero : public Module
{
 public:
	...
	Version GetVersion()
	{
		return Version("Implement JOIN 0 (joining 0 makes a user part all channels) as PARTALL");
	}
};
