...
class ModuleAccountHost : public Module
{
 ...
 public:
	...
	{
		this->hostprefix = ServerInstance->Config->ConfValue("accounthost")->getString("prefix");
		this->hostsuffix = ServerInstance->Config->ConfValue("accounthost")->getString("suffix");
		this->changereal = ServerInstance->Config->ConfValue("accounthost")->getBool("changereal");
	}
