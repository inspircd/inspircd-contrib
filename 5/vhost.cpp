 ...
 *   Copyright (C) 2013, 2019-2023 Sadie Powell <sadie@sadiepowell.dev>
...
/// $ModConfig: <vhost host="example.com" user="username" pass="password" hash="plaintext">
/// $ModDepends: core 5
/// $ModDesc: Allows the server administrator to define accounts which can grant a custom virtual host.
