 ...
 *   Copyright (C) 2013, 2018-2023 Sadie Powell <sadie@sadiepowell.dev>
...
/// $ModConfig: <title name="foo" password="$2a$10$UYZ4OcO8NNTCCGyCdY9SK.2GHiqGgxZfHFPOPmWuxEVWVQTtoDC7C" hash="bcrypt" title="Official Chat Helper">
/// $ModDepends: core 5
/// $ModDesc: Allows the server administrator to define accounts which can grant a custom title in /WHOIS and an optional virtual host.
...
public:
	ModuleCustomTitle()
		: Module(OPTCOMMON, "Allows the server administrator to define accounts which can grant a custom title in /WHOIS and an optional virtual host.")
