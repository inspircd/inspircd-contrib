 ...
 *
 *   Copyright (C) 2013, 2019-2021, 2023 Sadie Powell <sadie@sadiepowell.dev>
...
/// $ModConfig: <randquote file="quotes.txt" prefix="" suffix="">
/// $ModDepends: core 5
/// $ModDesc: Allows random quotes to be sent to users when they connect to the server.
