 ...
 *
 *   Copyright (C) 2013, 2021 Sadie Powell <sadie@sadiepowell.dev>
...
public:
	ModulePartMsgBan()
		: Module(VF_OPTCOMMON, "Adds extended ban p: (partmsg) which blocks the part message of matching users.")
