...
public:
	...
	{
		failrpl.Send(user, nullptr, "EXAMPLE", "FAIL with no command name.");
		warnrpl.Send(user, nullptr, "EXAMPLE", "WARN with no command name.");
		noterpl.Send(user, nullptr, "EXAMPLE", "NOTE with a command name.");
