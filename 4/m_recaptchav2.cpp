...
/// $ModConfig: <captchaconfig conninfo="dbname=example user=postgres password=secret hostaddr=127.0.0.1 port=5432" 
/// mode="master/slave" masterserver="master.example.com" url="http://meme.com/verify/" whitelistchan="#help,#support">
/// $ModDepends: core 4
